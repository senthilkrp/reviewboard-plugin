...
import com.senthil.exception.InvalidConfigurationException;
import com.senthil.exception.InvalidCredentialException;
import com.senthil.exception.ReviewBoardServerException;
...
public class ExceptionHandler {
    ...
    public static Message getMessage(Exception exception) {
        if (exception instanceof InvalidCredentialException || exception instanceof InvalidConfigurationException) {
            ...
            LOG.warn(exception.getMessage());
            return new Message("ERROR", Message.Type.WARNING);
    ...
    public static void handleException(Exception exception) {
        ...
        ApplicationManager.getApplication().invokeLater(new Runnable() {
            @Override
            public void run() {
                Notifications.Bus.notify(new Notification("ReviewBoard", "Notification",
